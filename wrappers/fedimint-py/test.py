...
from wrappers.fedimint_py.FedimintClient import FedimintClient
...
def main():
    ...
    data = fedimint_client.mint.encode_notes(data.notes_json)
    ...
    data = fedimint_client.mint.combine(notes_vec)
    ...
    data = fedimint_client.onchain.withdraw(data.address, 1000)
